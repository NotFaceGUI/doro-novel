...
3. **资源管理**
   ...
   应用程序的所以资源均文件位于 `resources` 下 您需要自行下载资源移动到文件夹下，包含以下目录（如果没有下面的目录请新建，确保和描述的目录结构一致）：

   特别声明：本软件安装包并不分发任何非公开的游戏资源，且只用于学习交流的目的。

   如果有疑问可以[点击加入群聊](https://qm.qq.com/q/9MSI0aQ7Z0)获取最新资讯，或解决方案。
