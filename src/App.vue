...
:root {
  ...
  --node-picker-overlay: rgba(0, 0, 0, 0.2);
  --node-picker-bg: rgba(29, 29, 42, 0.78);
  --node-picker-border: rgba(255, 255, 255, 0.06);
  --node-picker-shadow: 0 18px 36px rgba(0, 0, 0, 0.24);
  --node-picker-text: var(--floating-panel-text);
  --node-picker-muted-text: var(--placeholder-color);
  --node-picker-item-hover-bg: var(--high-hover-bg);
  --node-picker-item-hover-text: #ffffff;
  --node-picker-empty-text: #ccc;
  --node-picker-scrollbar: rgba(255, 255, 255, 0.14);
  --node-picker-scrollbar-hover: rgba(255, 255, 255, 0.24);
...
.light-theme {
  ...
  --node-picker-overlay: rgba(148, 156, 164, 0.18);
  --node-picker-bg: rgba(248, 249, 250, 0.94);
  --node-picker-border: rgba(173, 181, 189, 0.5);
  --node-picker-shadow: 0 18px 36px rgba(90, 98, 106, 0.18);
  --node-picker-text: var(--floating-panel-text);
  --node-picker-muted-text: var(--floating-panel-muted-text);
  --node-picker-item-hover-bg: rgba(173, 181, 189, 0.22);
  --node-picker-item-hover-text: #212529;
  --node-picker-empty-text: var(--floating-panel-soft-text);
  --node-picker-scrollbar: rgba(173, 181, 189, 0.52);
  --node-picker-scrollbar-hover: rgba(108, 117, 125, 0.56);
...
.theme-sakura {
  ...
  --node-picker-overlay: rgba(244, 202, 216, 0.22);
  --node-picker-bg: rgba(255, 246, 250, 0.95);
  --node-picker-border: rgba(224, 182, 199, 0.54);
  --node-picker-shadow: 0 18px 36px rgba(176, 105, 140, 0.16);
  --node-picker-text: var(--floating-panel-text);
  --node-picker-muted-text: var(--floating-panel-muted-text);
  --node-picker-item-hover-bg: rgba(232, 137, 172, 0.16);
  --node-picker-item-hover-text: #4f3341;
  --node-picker-empty-text: var(--floating-panel-soft-text);
  --node-picker-scrollbar: rgba(224, 182, 199, 0.62);
  --node-picker-scrollbar-hover: rgba(177, 122, 146, 0.54);
  --border-radius: 5px;
  --padding: 10px;
  --margin: 10px;
}
...
.theme-mint {
  ...
  --node-picker-overlay: rgba(196, 229, 216, 0.22);
  --node-picker-bg: rgba(244, 255, 251, 0.95);
  --node-picker-border: rgba(175, 213, 199, 0.56);
  --node-picker-shadow: 0 18px 36px rgba(69, 183, 154, 0.14);
  --node-picker-text: var(--floating-panel-text);
  --node-picker-muted-text: var(--floating-panel-muted-text);
  --node-picker-item-hover-bg: rgba(69, 183, 154, 0.14);
  --node-picker-item-hover-text: #20443c;
  --node-picker-empty-text: var(--floating-panel-soft-text);
  --node-picker-scrollbar: rgba(175, 213, 199, 0.64);
  --node-picker-scrollbar-hover: rgba(111, 158, 145, 0.54);
  --border-radius: 5px;
  --padding: 10px;
  --margin: 10px;
}
...
.theme-ocean {
  ...
  --node-picker-overlay: rgba(11, 20, 31, 0.3);
  --node-picker-bg: rgba(15, 29, 43, 0.88);
  --node-picker-border: rgba(68, 98, 122, 0.54);
  --node-picker-shadow: 0 20px 40px rgba(4, 12, 20, 0.32);
  --node-picker-text: var(--floating-panel-text);
  --node-picker-muted-text: var(--floating-panel-muted-text);
  --node-picker-item-hover-bg: rgba(59, 180, 230, 0.14);
  --node-picker-item-hover-text: #f1f6fb;
  --node-picker-empty-text: var(--floating-panel-soft-text);
  --node-picker-scrollbar: rgba(68, 98, 122, 0.7);
  --node-picker-scrollbar-hover: rgba(121, 144, 166, 0.56);
  --border-radius: 5px;
  --padding: 10px;
  --margin: 10px;
}
...
.theme-sunset {
  ...
  --node-picker-overlay: rgba(36, 22, 26, 0.3);
  --node-picker-bg: rgba(34, 23, 26, 0.9);
  --node-picker-border: rgba(118, 83, 90, 0.5);
  --node-picker-shadow: 0 20px 40px rgba(19, 12, 14, 0.32);
  --node-picker-text: var(--floating-panel-text);
  --node-picker-muted-text: var(--floating-panel-muted-text);
  --node-picker-item-hover-bg: rgba(240, 143, 88, 0.14);
  --node-picker-item-hover-text: #fff3eb;
  --node-picker-empty-text: var(--floating-panel-soft-text);
  --node-picker-scrollbar: rgba(118, 83, 90, 0.7);
  --node-picker-scrollbar-hover: rgba(181, 143, 136, 0.56);
  --border-radius: 5px;
  --padding: 10px;
  --margin: 10px;
}
